...
;
; 21st century code for 20th century CPUs
; 
...
; in .prg format -- the first two bytes are the load address in
...
ESCAPE      LDA #$8D        ;CR.
            ...
            LDA #$A0       ;Space
            JSR ECHO
GETLINE     LDY #$01        ;Initiallize text index.
...
AL1		dex
		...
		rts
;
MSG1      .textz "Welcome to JSMON Native16 1.0"
MSG5      .textz "SWEET16 Enabled (JSR to $C000)."
